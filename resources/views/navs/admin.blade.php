      ...
      <nav class="main_nav_container">
        <div class="main_nav">
          <ul class="main_nav_list">
            ...
            <li class="main_nav_item"><a href="{{url('/materiaadmin')}}"><i class="fas fa-book"></i>Materias</a></li>
            ...
            <li class="main_nav_item"><a href="{{url('/gradosadmin')}}"><i class="fas fa-chalkboard-teacher"></i>Grados</a></li>
